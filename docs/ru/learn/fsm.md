...
description: Как строить многошаговые диалоги с помощью машины состояний
...
!!! info
    ...
    Для разработки и тестирования этого достаточно. Для продакшена вы можете реализовать [свое постоянное хранилище](#_13).
