...
```
Bot(server, token, *, dispatcher=None, receive_unread_messages=False, verify_ssl=True, web_port=None, https=True, ws_max_retries=5, ws_max_delay=60, debug=False)
```
...
```
from_credentials(server, username, password, *, dispatcher=None, receive_unread_messages=False, verify_ssl=True, web_port=None, https=True, ws_max_retries=5, ws_max_delay=60)
```
